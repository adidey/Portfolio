...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    brief: 'Design a frictionless, guided fintech experience for novice traders to accumulate and build wealth.',
    goal: 'Simplify crypto investment through a guided, intuitive UI that removes the clutter of traditional trading platforms.',
    problem: 'Crypto trading platforms are notoriously cluttered. Novice traders need a frictionless, guided experience to accumulate and build wealth.',
