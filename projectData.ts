...
export const FULL_PROJECTS: Project[] = [
  ...
  },
  {
    ...
    shortDescription: 'Solving information fragmentation for researchers: Improved concept identification speed by 40% thro    context: 'Synapse was built to solve the "static note-taking" problem, where information ends up in disconnected graveyards. The biological metaphor is not decorative—it is the architectural thesis. Ebbinghaus\' Forgetting Curve demonstrates that isolated facts decay exponentially without reinforcement, and Miller\' Law caps working memory at 7±2 items. A linear note document violates both: it buries relationships and demands that the user reconstruct context from scratch every session. Synapse mirrors the biological neural web, creating a spatial environment where knowledge exists as a living network of associations. Adding a new concept like "Neural Networks" physically re-routes the graph, forcing the user to acknowledge prerequisite relationships to Linear Algebra and Calculus—an application of Constructivist learning theory in software form.',
    ...
    },s/synapse/main_knowledge_graph_1777509064798.png'
    ],
    sections: [
      {
  ...
  },
  {
    ...
    }, keep looking for these "hidden" hardware assets, building software that feels like it was designed as part of the machine itself.',
