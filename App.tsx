        ...
        <div className="max-w-[1800px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-24 items-start md:opacity-50 md:hover:opacity-100 transition-opacity duration-700">
            ...
            <div className="md:col-span-4 space-y-4">
              <p className="text-[9px] md:text-[10px] uppercase tracking-[0.4em] md:tracking-[0.5em] font-bold" style={{ fontFamily: 'Satoshi, sans-serif' }}>
                © 2025 ADITYA DEY™
              </p>
              <div className="flex items-center gap-3">
                <span className="w-1.5 h-1.5 bg-blue-600 rounded-full animate-pulse" />
                <p className="text-[8px] md:text-[9px] uppercase tracking-[0.3em] md:tracking-[0.4em]">Melbourne, Australia</p>
              </div>
            </div>

            {/* Social Links */}
            <div className="md:col-span-4">
              <p className="text-[8px] uppercase tracking-[0.6em] text-neutral-600 mb-6 md:mb-8">CONNECT_ARCHIVE</p>
              <div className="grid grid-cols-2 gap-x-8 md:gap-x-12 gap-y-4 md:gap-y-6 text-[10px] md:text-[11px] uppercase tracking-[0.3em] md:tracking-[0.4em] font-medium">
