...
const Navbar: React.FC<NavbarProps> = ({
  ...
  return (
    <>
      ...
      <div className="fixed top-6 right-6 md:top-8 md:right-8 z-[110] pointer-events-none">
        <button
          onClick={onToggleTheme}
          className="flex items-center justify-center bg-[var(--bg)]/60 backdrop-blur-xl border border-[var(--border)] rounded-sm p-3 md:p-4 pointer-events-auto transition-all duration-700 hover:bg-[var(--surface)] text-[var(--text)] shadow-sm"
        >
          {theme === 'dark' ? (
